...
# sbank --approximant IMRPhenomD_NRTidalv2 --aligned-spin --mass1-min 1.4 --mass1-max \
# 1.5 --spin1-min 0.0 --spin1-max 0.2 --mass2-min 1.4 --mass2-max 1.5 \
# --spin2-min 0.0 --spin2-max 0.0 --use-tidal --lambda1-only --lambda1-min 3000 --lambda2-max 5000 \
# --match-min 0.97 --flow 30.0 --noise-model aLIGOZeroDetHighPower \
